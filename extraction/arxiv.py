...
BASE_URL_DO_USUARIO = "https://arxiv.org/search/advanced?advanced=&terms-0-operator=AND&terms-0-term=%22spatial+data+structure%22&terms-0-field=abstract&terms-1-operator=OR&terms-1-term=%22geospatial+data+structure%22&terms-1-field=abstract&terms-2-operator=OR&terms-2-term=%22quadtree%22&terms-2-field=abstract&terms-3-operator=OR&terms-3-term=%22r-tree%22&terms-3-field=abstract&terms-4-operator=OR&terms-4-term=%22m-tree%22&terms-4-field=abstract&terms-5-operator=OR&terms-5-term=%22kd-tree%22&terms-5-field=abstract&terms-6-operator=OR&terms-6-term=%22spatial+index%22&terms-6-field=abstract&classification-computer_science=y&classification-physics_archives=all&classification-include_cross_list=include&date-filter_by=all_dates&date-year=&date-from_date=&date-to_date=&date-date_type=submitted_date&abstracts=show&size=200&order=-submitted_date"
